...
class UserResource {
  ...
  // Call Register API
  static Resource register(RegisterHeroRequestModel requestModel) {
    return Resource(
        url: 'heroes/register',
  ...
  static Resource checkIcNumber(String icNo) {
    return Resource(
        url: 'check-ic-number/' + icNo,
        parse: (response) {
          return DefaultResponseModel(json.decode(response.body));
        });
  }
  ...
  // To check Discount Code exist or not
  static Resource checkDiscountCode(String discountCode) {
    return Resource(
        url: 'check-discount-code/' + discountCode,
        parse: (response) {
          return DefaultResponseModel(json.decode(response.body));
        });
  }
